...
python .\tools\scripts\btxt.py -cb us_english.txt -p %cd%\temp\us_english.txt
...
ren ".\Patch-Translation\010093801237C000\romfs\system\fonts\occ_40.bfont" occ_42.bfont
